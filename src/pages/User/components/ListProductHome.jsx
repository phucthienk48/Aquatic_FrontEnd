...
const fishList = products.filter((p) => p.type === "fish").slice(0, 4);
const medicineList = products.filter((p) => p.type === "medicine").slice(0, 4);
const equipmentList = products.filter((p) => p.type === "equipment").slice(0, 4);
...
const renderList = (title, icon, list) => (
  ...
  return (
    <div style={styles.container}>
      <h2 className="mb-4 d-flex align-items-center gap-2" style={styles.title}>
        <i className="bi bi-stars text-primary fs-3"></i>
